...
public record UpdateProductDTO(
        ...
        @NotNull(message = "ID is required") @Min(value = 1, message = "ID must be at least 1") Long id,

        @NotBlank(message = "Product name is required") String name,

        @NotNull(message = "User ID is required") @Min(value = 1, message = "User ID must be at least 1") Long userId,
